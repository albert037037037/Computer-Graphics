...
void drawPlane()
{
    ...
    quad.vertex_count = sizeof(vertices) / 3;
...
void scroll_callback(GLFWwindow* window, double xoffset, double yoffset)
{
    ...
    switch (cur_trans_mode) {
        ...
        case GeoRotation:
            ...
            break;
        case ViewCenter:
            main_camera.center.z += yoffset/5;
            break;
        case ViewEye:
            main_camera.position.z -= yoffset/5;
            break;
        case ViewUp:
            main_camera.up_vector.z -= yoffset/5;
            break;
    }
    ...
    if(mousePress) {
        switch(cur_trans_mode) {
            ...
            case GeoRotation:
                ...
                break;
            case ViewCenter:
                main_camera.center.x -= diffx / 80;
                main_camera.center.y += diffy / 80;
                break;
            case ViewEye:
                main_camera.position.x -= diffx / 80;
                main_camera.position.y -= diffy / 80;
                break;
            case ViewUp:
                main_camera.up_vector.x += diffx / 80;
                main_camera.up_vector.y += diffy / 80;
                break;
        }
